      ...
      <div className="flex flex-col gap-1 text-left">
        ...
        >
          <div className="flex items-center gap-3">
            <svg className="w-5 h-5 text-zinc-555 dark:text-zinc-400 group-hover:text-brand-red transition-colors" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
